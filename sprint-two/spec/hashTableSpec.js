describe('hashTable', function () {
  ...
  it('should store values that were inserted', function () {
    ...
    hashTable.insert('mac', 'Seagal');
    hashTable.insert('wefadsa', 'Seagal');
    hashTable.insert('fvavae', 'Seagal');
    hashTable.insert('vaeew', 'Seagal');
    hashTable.insert('asdbwebas', 'Seagal');
